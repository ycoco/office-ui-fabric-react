 ...
 */
export function includeInSum(source: KnockoutObservable<number>, target: KnockoutObservable<number>): KnockoutSubscription {
    var current: number;
 ...
 */
export function includeInHistogram(source: KnockoutObservable<string>, target: KnockoutObservable<{
    [key: string]: number;
 ...
 */
export function setFirst<T>(source: KnockoutObservable<T>, target: KnockoutObservable<T>): KnockoutSubscription {

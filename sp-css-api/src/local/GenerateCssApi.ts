...
export class GenerateCssApi {
    ...
    public Generate() {
        ...
        styles += this._makeBlocks('.sp-css-backgroundColor-{0}', 'background-color', standardSlots);
        styles += this._makeBlocks('.sp-css-color-{0}', 'color', standardSlots);
        styles += this._makeBlocks('.sp-css-borderColor-{0}', 'border-color', standardSlots);

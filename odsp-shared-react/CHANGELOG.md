...
This log was last generated on Fri, 11 Aug 2017 16:56:40 GMT and should not be manually modified.

## 23.0.1
Fri, 11 Aug 2017 16:56:40 GMT

### Patches

- Remove FilterPanelTypeAhead flight check since it is 100% in PROD.
...
- Add custom formatter to column schema values and defaults helper. Add a test for it.
...
- added single choice with fill-in editor
...
- Add DateTimeFieldeditor with iframed classic date picker
...
- Added classification descriptions to site information panel.
...
- add callback for peoplepicker suggetion resolved
...
- Site settings: add department field, decrease minified size
...
- ChangeTheLookPanel: Themes now work with glamor properly, also now handles errors appropriately
...
- ChangeTheLookPanel: Updated the default themes to be in line with new algorithm"
...
- Accessibility fixes for SiteLogo
...
- Fix a null check bug

## 19.5.1
Thu, 22 Jun 2017 04:52:31 GMT

### Patches

- Integrate ReactClientForm into odsp-next and minor bug fixes
...
- Comm site Navigation, EditNav, HorizontalNav accessibility fixes
...
- Removed “Sharing with guests permitted” string for teamsite.
...
- Allow add/remove guests when permitted

## 18.17.0
Thu, 25 May 2017 17:35:21 GMT

### Minor changes

- Add link to search for members
...
- Fix example page to not have exceptions

## 18.13.4
Fri, 19 May 2017 18:14:15 GMT

### Patches

- Updated Fabric UI button.
...
- Allow relative URLs in a secure way
- resize circle, made focus border better
...
- Move filterSelect control and related code to dosp-common

## 18.9.4
Mon, 15 May 2017 22:51:36 GMT

### Patches

- Changing the disable state for the Add member button 

## 18.9.3
Mon, 15 May 2017 22:25:17 GMT
...
## 18.9.2
Mon, 15 May 2017 22:00:41 GMT

### Patches

- Fix problem with default value not being matched properly
...
- ChangeTheLookPanel: Adding in names and circle

## 18.7.2
Sat, 13 May 2017 02:05:31 GMT
...
## 18.7.1
Thu, 11 May 2017 20:36:41 GMT

### Patches

- Fix some padding css bugs

## 18.7.0
Thu, 11 May 2017 20:14:59 GMT

### Minor changes

- Add onRenderMissingItem to CardList
...
- Add support for creating and editing number and yes/no fields
...
- Allow aria-* tags as valid attributes
...
- Added anonymous user and external user check for creategroupcontext.
...
- Fix edit panel column validation section
...
- Minor update to comm site header

## 18.1.2
Fri, 28 Apr 2017 00:43:26 GMT

### Patches

- Fix minor accessibility and padding bugs.
...
- HorizontalNav Edit button alignment css change
...
## 17.5.3
Fri, 21 Apr 2017 21:04:33 GMT

### Patches

- adding a new css clas
...
- 'Adding css to make sure the spacing for options is correct" 
...
- Remove site permission panel's dependency on group
...
- Clean up CSS for group membership panel
...
- Minor comm site header css update
...
- Left align the tip tile content
...
## 15.7.0
Wed, 29 Mar 2017 17:57:01 GMT

### Minor changes

- Show spinner when group member status updating
...
## 15.5.5
Thu, 23 Mar 2017 18:29:47 GMT

### Patches

- Make group membership error messages dismissible
...
- HorizontalNav node is using <a/> or <a/><button/>
...
- Add new create choice column panel

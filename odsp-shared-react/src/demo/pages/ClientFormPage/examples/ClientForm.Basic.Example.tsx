...
export class ClientFormBasicExample extends React.Component<any, IClientFormBasicExampleState> {
    ...
    private _mockFilterData = '<SELECT id="diidFilterChoiceWithFillIn" TITLE="Filter by withinput" OnChange=' + "'" + 'FilterField("{84ECD14B-D4A6-44B8-B254-BBD37ECA5A55}","withinput",this.options[this.selectedIndex].value, this.selectedIndex);' + "'" + 'dir=""><OPTION  SELECTED Value="">(All)</OPTION><OPTION Value="fall" >fall</OPTION><OPTION Value="summer" >summer</OPTION></SELECT><br><a id="diidSortwithinput" onfocus="OnFocusFilter(this)" class="ms-headerSortTitleLink" title="Sort by withinput" href="javascript:" onclick="javascript:return OnClickFilter(this,event);"  SortingFields="SortField=withinput&amp;SortDir=Asc&amp;View=%7b84ECD14B%2dD4A6%2d44B8%2dB254%2dBBD37ECA5A55%7d">withinput<img src="/_layouts/15/images/blank.gif?rev=44" class="ms-hidden" border="0" width="1" height="1" alt="Use SHIFT+ENTER to open the menu (new window)."/></a><img src="/_layouts/images/blank.gif" alt="" data-accessibility-nocheck="true" border="0"/><img src="/_layouts/images/blank.gif" border="0" alt="" data-accessibility-nocheck="true"/>';
    ...
    constructor() {
        ...
        this._reactClientFormProps.getFieldFilterData = (fieldName) => this.getFilterData(fieldName);
    ...
    public getFilterData(filterField: string): Promise<string> {
        let async = new Async(this);
        let onExecute = (complete: any, error: any) => {
            async.setTimeout(() => {
                complete(this._mockFilterData);
            }, 10);
        };
...
const mockProps = `
{
    "clientForm":{
        ...
        "fields":[
            {
                "schema":{
                "Id":"5a450000-5d76-4430-ba14-eebe931cc613",
                "Title":"ChoiceWithFillIn",
                "InternalName":"ChoiceWithFillIn",
                "StaticName":"ChoiceWithFillIn",
                "Hidden":false,
                "IMEMode":null,
                "Name":"ChoiceWithFillIn",
                "Required":false,
                "Direction":"none",
                "FieldType":"Choice",
                "Description":"",

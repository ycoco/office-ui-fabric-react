...
const EXPECTATION_MAP = [
  ...
  { sample: formatExamples[1], result: '<a style="padding:6px;border:1px solid #aaaaaa;display:inline-block;text-decoration:none;border-radius:5px;;"  target="_blank"  href="http://finance.yahoo.com/quote/MSFT" >Microsoft</a>', sampleIndex: 0 },
  ...
  { sample: formatExamples[7], result: '<a  href="alert(&#39;foo&#39;)"  target="_blank"  src="http://covers.openlibrary.org/b/isbn/&lt;script&gt;alert(&#39;foo&#39;)&lt;/script&gt;-M.jpg" >&lt;script&gt;alert(&#39;foo&#39;)&lt;/script&gt;</a>', sampleIndex: 0 },
  { sample: formatExamples[8], result: '<div style="color:#ff0000;" >Cyrus Balsara</div>', sampleIndex: 0 },
  { sample: formatExamples[9], result: '<div style="color:#ff0000;" >Tue Mar 21 2017</div>', sampleIndex: 0 },

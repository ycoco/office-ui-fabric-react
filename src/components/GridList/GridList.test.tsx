...
describe('GridList', () => {
  ...
  it('should render 10 items', () => {
    ...
    let defaultBoundingRect = Element.prototype.getBoundingClientRect;
    Element.prototype.getBoundingClientRect = function() {
      if (this.className === 'ms-List-surface') {
        return {
          left: 0, right: 1024,
          top: 0, bottom: 1024,
          width: 1024,
      ...
      return defaultBoundingRect.apply(this);
    };
    ...
    // Remember to revert to the default function
    Element.prototype.getBoundingClientRect = defaultBoundingRect;
  });
